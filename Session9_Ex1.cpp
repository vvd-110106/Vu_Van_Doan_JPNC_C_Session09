...
int main(){
	...
	printf("\nBan hay nhap vao gia tri ma ban muon them: ");
	scanf("%d", &value);
	printf("Ban hay nhap vao vi tri ma ban muon them: ");
	scanf("%d", &position);
    ...
    // Chen phan tu vao vi tri xac dinh
	...
	// Tang kich thuoc de them phan tu
    size++;
